...
public class InternetSystem extends javax.swing.JFrame {
    ...
    public InternetSystem() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(itemArray));
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Select Item for COVID-19:");

        jComboBox2.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 15)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(name.getText().isEmpty() | telNo.getText().isEmpty() | address.getText().isEmpty()){
            ...
            String data2 ="\nSpecial Item for COVID-19:" + "\n" + itemArray[jComboBox2.getSelectedIndex()];
            
            if(jComboBox1.getSelectedIndex() == 0){
               jTextArea1.setText(data1 + wifi1.display() +  wifi1.special("Wired") +  data2);
               jTextArea1.setEditable(false);
            }
            else if(jComboBox1.getSelectedIndex() == 1){
                    jTextArea1.setText(data1 + wifi2.display() + wifi2.special("Wired") + data2);
                    jTextArea1.setEditable(false);
                  }
                  else if(jComboBox1.getSelectedIndex() == 2){
                          jTextArea1.setText(data1 + wifi3.display() + wifi3.special("Wireless") + data2);
                          jTextArea2.setEditable(false);
                        }
                        else if(jComboBox1.getSelectedIndex() == 3){
                                jTextArea1.setText(data1 + wifi4.display() + wifi4.special("Wireless") + data2);
                                jTextArea1.setEditable(false);
                              }
                              else{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(jCheckBox1.isSelected()){
            ...
            double getPrice = 0;
            int getSpeed = 0;
            String getItem = itemArray[jComboBox2.getSelectedIndex()];
            ...
            Internet info = new Internet(getName, getTelNo, getAddress, getWifiName,getPrice,getSpeed,getItem);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InternetSystem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
