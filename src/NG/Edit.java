...
public class Edit extends javax.swing.JFrame {
    ...
    String[] itemArray = {"Free 30GB Data Digi SIM Card",
                          "RM 15 Free Petrol Change",
                          "Free RM 10 Voucher Online Shopping"};
    ...
    public Edit() {
        ...
        for ( int i = 0; i < internet.size(); i++){
            ...
            internetArray[i] = internet.get(i).getName();
        }
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(itemArray));
    ...
    public void saveToFile(){
        ...
        try{
            ...
            try(FileWriter Writer = new FileWriter("Internet.txt",false)) {
                    ...
                    Writer.write(String.format(" %-20s%-15s%-30s%-20s%-15s%-15s%-30s%n%n","NAME","TEL.NO","ADDRESS","INTERNET","PRICE(RM)", "SPEED(mbps)","ITEM COVID-19"));
                    for(int i = 0; i < internet.size(); i++){
                        Writer.write(String.format(" %-20s%-15s%-30s%-20s%-15.2f%-15d%-30s%n%n", internet.get(i).getName(),internet.get(i).getTelNo(),internet.get(i).getAddress(),
                                        internet.get(i).getWifiName(),internet.get(i).getPrice(),internet.get(i).getSpeed(), internet.get(i).getItemCOVID19()));
                    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().isEmpty() | jTextField2.getText().isEmpty() | jTextField3.getText().isEmpty()){
            ...
            internet.get(selectedIndex).setItemCOVID19(itemArray[jComboBox3.getSelectedIndex()]);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        jTextArea1.setText(internet.get(selectedIndex).getWifiName() + "\nRM " + 
                           formatter.format(internet.get(selectedIndex).getPrice()) + "\n" + 
                           internet.get(selectedIndex).getSpeed() + " mbps" + "\n" +
                           "Item Selected: " + internet.get(selectedIndex).getItemCOVID19());
